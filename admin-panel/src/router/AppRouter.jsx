...
import ManagePricing from "../pages/dashboard/ManagePricing/ManagePricing.jsx";
import AddEditPricing from "../pages/dashboard/ManagePricing/AddEditPricing.jsx";
import ManageFlashBanner from "../pages/dashboard/ManageFlashBanner/ManageFlashBanner.jsx";
          ...
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              ...
              /> */}
                ...
                />
                <Route
                  path="/dashboard/ManagePricing"
                  element={<ManagePricing />}
                />
                <Route
                  path="/dashboard/ManagePricing/add"
                  element={<AddEditPricing />}
                />
                <Route
                  path="/dashboard/ManagePricing/edit/:id"
                  element={<AddEditPricing />}
                />
                <Route
                  path="/dashboard/ManageFlashBanner"
                  element={<ManageFlashBanner />}
                />
              </Route>
            </Route>
