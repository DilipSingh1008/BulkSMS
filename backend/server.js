...
const pricingRoutes = require("../backend/routes/pricingRoutes");
const flashBannerRoutes = require("./routes/flashBannerRoutes");
5558;
connectDB();
...
app.use("/api/flash-banner", flashBannerRoutes);
